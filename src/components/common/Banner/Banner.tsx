...
const Banner: React.FC<any> = () => {
  return (
    <div className="max-w-[1600px] w-full mx-auto relative">
      ...
      <div className="relative bottom-0 max-w-full w-full bg-black md:bg-transparent md:absolute md:w-3/4 pl-[15px] pb-4 md:pl-12 md:pb-12 pt-2 pr-[15px] text-white z-20">
        <div className="w-fit text-6 md:text-[40px] font-din-light leading-[76px] font-normal">
          A career that's&nbsp;
